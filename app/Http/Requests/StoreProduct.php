...
class StoreProduct extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'descriptionShort'  => 'string|max:255',
            'descriptionLarge'  => 'string|max:255',
    ...
    public function messages()
    {
        return [
            ...
            'descriptionShort.string'   => 'La descripción corta debe contener caracteres válidos',
            'descriptionShort.max'      => 'La descripción corta es muy larga',
            'descriptionLarge.string'   => 'La descripción larga debe contener caracteres válidos',
